...
function MusicPage() {
  ...
  const musicQuotes = {
    ...
    fearful: ['"When fear whispers, let music be your shield"', '"Music is the light that guides you through the darkness"', '"A song can be the hand that pulls you out of fear"', '"Fear fades when the right song plays"', '"Music speaks louder than the fears in my mind"'],
